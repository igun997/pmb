...
<div class="container">
    <div class="col-md-6">
        ...
        <div class="block-web success-box">
            ...
            <div class="porlets-content">
                ...
                <p>Pertanyaan dan Informasi, silahkan kontak Panitia di ppdb.smkkesrajawali@gmail.com (GTalk/Hangout) Atau 081224163795</p>
            </div>
        </div>
    ...
    <div class="col-md-6">
                ...
                <div class="table-responsive">
                    <table class="table table-invoice">
                        ...
                        <?php
                            ...
                            $biaya = mysqli_query($konek, "SELECT * from biaya");
                            $no=1;
        ...
        //$jenis_kelamin = $row['jenis_kelamin']=='P'?'Perempuan':'Laki laki';
                        ...
                        <tr>
                        <td>
                <div><strong>".$row['komp']."</strong></div>
            </td>
            <td>
                Rp.".$row['besar']." </td>
                <td>
