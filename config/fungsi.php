...
function daftarformulir($nama,$tempat,$date,$jns_kel,$agama,$nohp,$alamat,$provinsi,$jurusan,$no_jaket,$email){
	global $konek;

	$sql="INSERT INTO `formulir_mhs`(`nama_lengkap`, `tempat_lahir`, `tgl_lahir`, `jenis_kelamin`, `agama`, `no_hp`, `alamat`, `provinsi`, `jurusan` ,`no_jaket`,`email`, `tgl_daftar`) VALUES ('$nama','$tempat','$date','$jns_kel','$agama','$nohp','$alamat','$provinsi','$jurusan','$no_jaket','$email','$date')";
...
function simpandataortu($namapendaftar,$id_pendaftar,$ayah,$ibu,$wali,$alamat,$provinsi,$kota,$kecamatan,$kodepos,$nohp,$email_ortu,$pendidikan_ayah,$pendidikan_ibu,$pekerjaan_ayah,$pekerjaan_ibu,$penghasilan_ortu){
	...
	$sql="INSERT INTO `data_orangtua`(`nama_pendaftar`, `id_pendaftar`, `nama_ayah`, `nama_ibu`, `nama_wali`, `alamat`, `provinsi`, `kota`, `kecamatan`, `kodepos`, `nohp`, `email_ortu`, `pendidikan_ayah`, `pendidikan_ibu`, `pekerjaan_ayah`, `pekerjaan_ibu`, `penghasilan_ortu`) VALUES ('$namapendaftar','$id_pendaftar','$ayah','$ibu','$wali','$alamat','$provinsi','$kota','$kecamatan','$kodepos','$nohp','$email_ortu','$pendidikan_ayah','$pendidikan_ibu','$pekerjaan_ayah','$pekerjaan_ibu','$penghasilan_ortu','$status')";
	if (mysqli_query($konek, $sql)) {
		    return true;
		} else {
		    return false;
