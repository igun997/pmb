...
//   $kode=$_POST['kode'];
  ...
  if($email===$konfirmemail){
    ...
    // if($_SESSION["Captcha"]==$kode){
        ...
        if(daftarformulir($nama,$tempat,$date,$jns_kel,$agama,$nohp,$alamat,$provinsi,$jurusan,$no_jaket,$email,$date)){
    ...
    <div class="row" style="margin-left:0;margin-right:0;">
        ...
        <div class="jumbotron daftar">
            ...
            <form action="" method="post">
              ...
              <input type="radio" name="jns_kel" value="laki-laki"><span class="custom-radio" required></span> Laki-laki  
          </label>
                    <label class="radio-inline">
              <input type="radio" name="jns_kel" value="perempuan"><span class="custom-radio" required></span> Perempuan  
          </label>
                </div>
            ...
            <select name="jurusan" class="form-control" required>
                ...
                <div class="form-group">
                   ...
                   <!-- <input type="text" name="jp" class="form-control" placeholder="Jalur Pendaftaran" required>-->
                    <select name="jp" class="form-control" required>
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">Informasi Pendaftaran </label>
                   <!-- <input type="text" name="ip" class="form-control" placeholder="Informasi Pendaftaran " required>-->
                    <select name="ip" class="form-control" required>
                        <option value="">Silahkan Pilih</option>
                        <option value="or" >Orang Tua</option>
                        <option value="ts">Teman Sekolah</option>
